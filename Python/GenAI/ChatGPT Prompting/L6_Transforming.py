...
#Translation: ChatGPT is trained with sources in many languages. 
...
#Universal Translator: Using LLM to translate in receiving and sending messages
...
#Identifying Language and translating messages
